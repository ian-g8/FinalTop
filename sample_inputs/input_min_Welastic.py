    ...
    "load_cases": [
        {
            "name": "Mag_UP",
            "weight": 1.0,
            "B_app_mag": 10.0,   # DOES NOT EFFECT ANYTHING
            "B_app_dir": (0.0, 1.0),
            "tractions": {
                "out_right": (0.0, 0.001),
            },
...
opt = {
    ...
    "compliance_constraint": True,
    "compliance_ref": 0.125,  # start 0.255
    "compliance_gamma": 1.0,  

    # Objective
    "objective_type": "min_elastic_energy", # compliance, max_disp, disp_track
    "enforce_volume_equality": True,

    # Output
    "output_dir": "./min_We_results/",
