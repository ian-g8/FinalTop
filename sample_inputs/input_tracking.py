...
# ============================================================
#  FEM PARAMETERS FOR SIMULTANEOUS ρ + φ OPTIMIZATION
# ============================================================
...
fem_params = {
    ...
    "traction_bcs": [
        {
            "traction_max": (0.0, -0.01),        # downward pull
...
# ============================================================
#  OPTIMIZATION PARAMETERS (ρ + φ simult.)
# ============================================================
...
opt = {
    ...
    "disp_track": {
        "point": (100.0, 20.0),     # physical coordinates in domain units
        "component": "y",           # track y-displacement only (Zhao-style)
        "target": -5.0,              # prescribed displacement (same units as u)
    },

    # Output
    "output_dir": "./track_compL_results/",
